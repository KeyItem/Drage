...
//Modified by @Key_Items, original script provided by cmilr - https://github.com/cmilr/DeadSimple-Pixel-Perfect-Camera
...
public class DSPixelPerfectCamera : MonoBehaviour
{
	...
	private void SetOrthographicSize()
	{
        ...
        if (camera != null)
        {
            ...
            int tempUnitSize = Screen.height / verticalUnitsOnScreen;
