...
public class EnemyCollisionManager2D : CollisionManager2D
{
    ...
    public override void ManageObjectCollisions(ref Vector2 objectVelocity, Vector2 objectInputDirection)
    {
        SearchForPlayer();

        base.ManageObjectCollisions(ref objectVelocity, objectInputDirection);
    }
