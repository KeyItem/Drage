...
public class CollisionManager2D : MonoBehaviour
{
    ...
    public virtual void ManageObjectCollisions(ref Vector2 objectVelocity, Vector2 inputDirection)
    {
        UpdateObjectBounds();
        ...
        DetectHorizontalCollisions(ref objectVelocity, inputDirection);

        if (objectVelocity.y != 0)
        {
            DetectVerticalCollisions(ref objectVelocity, inputDirection);
        }
    }
