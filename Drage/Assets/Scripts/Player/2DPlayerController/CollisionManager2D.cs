    ...
    public virtual void DetectHorizontalCollisions(ref Vector2 objectVelocity)
    {
        ...
        for (int i = 0; i < collisionHorizontalRayCount; i++)
        {
            ...
            if (rayHit)
            {
                ...
                if (!collisionData.collidedObjects.ContainsValue(rayHit.collider.gameObject))
                {
                    collisionData.collidedObjects.Add((collisionData.collidedObjects.Count + 1), rayHit.collider.gameObject);
                }
...
public struct CollisionData2D
{
    ...
    [Space(10)]
    public Dictionary<int, GameObject> collidedObjects;
    ...
    {
        collidedObjects = new Dictionary<int, GameObject>();
    }
